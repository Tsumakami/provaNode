...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>cadastro de Médicos</h1><div class=\"container\"><form action=\"/medicos\" method=\"post\"><div class=\"row\"><a href=\"/listagem\">Voltar a listagem</a></div><div class=\"row\"><h3>Dados pessoais</h3></div><div class=\"row\"><div class=\"col-md-4\"><label for=\"nome\">Nome</label><input type=\"text\" class=\"form-control\" name=\"nome\"></div><div class=\"col-md-4\"><label for=\"crm\">CRM</label><input type=\"text\" class=\"form-control\" name=\"crm\"></div><div class=\"col-md-4\"><label for=\"data\">Data de Nascimento</label><input type=\"date\" class=\"form-control\" name=\"data\"></div></div><div id=\"contato\"><div class=\"row\"><h3>Dados para Contato</h3></div><div class=\"row\"><div class=\"col-md-4\"><label for=\"endereco\">Endereco</label><input type=\"text\" class=\"form-control\" name=\"endereco\"></div><div class=\"col-md-4\"><label for=\"telefone\">Telefone</label><input type=\"tel\" class=\"form-control\" name=\"telefone\"></div></div></div><button type=\"button\" class=\"btn btn-success\" id=\"add-endereco\">Adicionar outro endereco</button><div class=\"row\"><h3>Especialidades e Patologias</h3></div>");

  var for__39 = 0;

  marko_forEach(data.especialidades, function(especialidade) {
    var keyscope__40 = "[" + ((for__39++) + "]");
